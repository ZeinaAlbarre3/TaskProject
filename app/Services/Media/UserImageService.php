...
class UserImageService extends MediaService
{
    ...
    public function uploadUserImage($file, $userId): array
    {
        return $this->uploadFile(
            $file,
            $userId,
            MediaModel::USER_MEDIA->value,
            MediaType::IMAGE->value,
            MediaCategory::USER->value,
            MediaFolder::USER_MEDIA->value
        );
    }

    public function uploadMultipleUserImages($files, $userId): array
    {
        return $this->uploadMultipleFile(
            $files,
            $userId,
            MediaModel::USER_MEDIA->value,
            MediaType::IMAGE->value,
